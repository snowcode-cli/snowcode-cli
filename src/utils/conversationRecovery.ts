...
// resume bounded well below the multi-GB failure mode while leaving enough
// room for normal compacted sessions plus resume hook context.
...
function assertResumeMessageSize(messages: unknown[]): void {
...
export async function loadConversationForResume(
  ...
  try {
    ...
    // Append hook messages and guard again in case hook output itself
    // pushes the session over the safe resume limit.
