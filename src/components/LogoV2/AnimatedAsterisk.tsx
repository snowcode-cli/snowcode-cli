...
export function AnimatedAsterisk({
  ...
  // Also disable animation on Windows where the color animation can cause
  // terminal rendering artifacts that lead to keyboard input freeze.
  const [reducedMotion] = useState(
    () => process.platform === 'win32' || (getInitialSettings().prefersReducedMotion ?? false)
  );
