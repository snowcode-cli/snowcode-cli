...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, snow.md entries, or any past session summaries), update the session notes file.
...
- Do not include information that's already in the SNOW.md files included in the context
